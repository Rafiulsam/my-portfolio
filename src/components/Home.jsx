...
const Home = ({ theme }) => {
  const banner_img =
    theme === "dark" ? "/banner_pic_red.webp" : "/banner_pic.webp";
  return (
    <section
      id="home"
      className="container mx-auto mt-20 md:mt-0 h-[100dvh] md:min-h-screen px-10 flex flex-col md:flex-row items-center justify-center md:justify-between relative overflow-x-hidden"
    >
      ...
      >
        ...
        <h1 className="text-8xl lg:text-[12rem] font-bold text-white">
          <i>
            <span className="text-black  dark:text-red-700">Sam</span>eer
          </i>
        </h1>
        <p className="mt-4 lg:text-xl px-8 md:p-0 text-white">
          A passionate front-end developer building user-friendly web
          experiences.
        </p>
        <Link
          to="/projects"
