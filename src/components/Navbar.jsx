...
const Navbar = ({ theme, toggleTheme }) => {
  ...
  return (
    <nav
      style={{ width: isScrolled ? "100%" : "calc(100% - 3rem)" }}
      className={`${navbarBg} ${isScrolled ? "rounded-none top-0" : "rounded-full top-5"} shadow-lg shadow-red-400 dark:shadow-gray-400 fixed left-1/2 z-50 -translate-x-1/2 transition-all duration-500 ease-in-out flex justify-center items-center`}
    >
          ...
          >
            ...
            <div className="flex px-3 py-2 space-x-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex text-center border px-2 text-white rounded-md hover:bg-black hover:bg-opacity-50 transition"
              >
